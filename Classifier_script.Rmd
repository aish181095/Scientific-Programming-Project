...
```{r}
##Merging classes into classes (No_severity, Mild_severity,Moderate_severity, Severity into one class)
...
#Remove the redundant clomuns from dataframe
...
#ploting teh confusion matrix for validation dataset
...
```{r}
##Ploting teh ROC curve for Test dataset
