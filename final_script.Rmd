...
model_rf_over <- ranger(~ class, data=train_data,num.trees = 1000,importance = "impurity",verbose=TRUE)
pred.data <- predict(model_rf_over, data = test_data)
table(test_data$class, pred.data$predictions)
